...
export default function Plc1ContentPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      setPlc1(parsedPlan.plc1 || EMPTY_PLC);
    } catch {
  ...
  const runLoadingSequence = () => {
    const timers = [
      setTimeout(() => {
        setLoadingStep(1);
        setLoadingMessage("กำลังอ่าน Avatar และ PLC 1 Strategy...");
      }, 0),
      setTimeout(() => {
        setLoadingStep(2);
        setLoadingMessage("กำลังเขียนเนื้อหา Prelaunch 1...");
      }, 1200),
      setTimeout(() => {
        setLoadingStep(3);
  ...
  const generateContent = async () => {
    ...
    try {
      const res = await fetch("/api/launch-sequence/prelaunch-content/plc-1", {
        method: "POST",
        headers: {
  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 space-y-8">
        <div>
          <h1 className="text-4xl font-bold mb-3">เนื้อหา Prelaunch 1</h1>
          <p className="text-lg text-gray-700">
            สร้างเนื้อหา PLC 1 จาก Avatar และ Prelaunch Strategy ที่บันทึกไว้
          </p>
        </div>
        ...
        {plc1.headline && (
          <div className="border rounded-xl p-6 bg-gray-50 space-y-4">
            <h2 className="text-2xl font-semibold">PLC 1 Strategy ที่ใช้อยู่</h2>
            <div className="text-sm leading-7">
              <strong>Headline:</strong> {plc1.headline}
            </div>
        ...
        {loading && !generatedContent && (
          <div className="border rounded-xl p-6 bg-gray-50">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-xl font-semibold">กำลังสร้างเนื้อหา Prelaunch 1</h2>
            </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              >
                {loadingStep >= 1 ? "✓" : "○"} อ่าน Avatar และ PLC 1 Strategy
              </div>
              <div
                className={`flex items-center gap-2 ${
              ...
              >
                {loadingStep >= 2 ? "✓" : "○"} เขียนเนื้อหา Prelaunch 1
              </div>
              <div
                className={`flex items-center gap-2 ${
        ...
        {!generatedContent && (
          <div className="flex flex-wrap gap-3">
            ...
            >
              {loading ? "กำลังสร้าง..." : "สร้างเนื้อหา Prelaunch 1"}
            </button>
          </div>
        )}
