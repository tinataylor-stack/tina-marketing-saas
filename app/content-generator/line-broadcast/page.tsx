...
export default function LineBroadcastGeneratorPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-8">
        <div>
          <h1 className="text-4xl font-bold mb-3">Line Broadcast Generator</h1>
          <p className="text-lg text-gray-700">
            หน้านี้พร้อมรับ brief จากวันที่เลือกใน 30-Day Content Planner
            และจะใช้ต่อยอดเป็นข้อความ LINE Broadcast ในขั้นถัดไป
          </p>
        </div>
